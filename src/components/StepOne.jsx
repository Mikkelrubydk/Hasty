  ...
  return (
    <section className="step1section">
      ...
      <div className="boks-container">
        <div>
        <div className={`boks ${activeIcon === 0 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 1 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 2 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 3 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 4 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 5 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 6 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 7 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 8 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 9 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 10 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 11 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 12 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 13 ? "active" : ""}`}
        ...
        <div>
        <div className={`boks ${activeIcon === 14 ? "active" : ""}`}
